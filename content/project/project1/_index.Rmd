...
3. Build the final report `hw1_report.Rmd` = `hw1_ex1.Rmd` + `hw1_ex2.Rmd` + `hw1_ex3.Rmd` + `hw1_ex4.Rmd`.
...
The [solutions for HW1 are available here](https://raw.githubusercontent.com/tvatter/dsfba_2020/master/static/solutions/dsfba_homework1_solution.zip).
